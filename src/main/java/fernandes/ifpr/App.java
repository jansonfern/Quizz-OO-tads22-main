...
public class App extends Application {
    ...
    // Instâncias dos controles de UI
    ...
    public void init() throws Exception {
        ...
        lista.add(new Questao("Qual a capital de Sao Paulo?", "Sao Paulo",
                        new String[] { "Sao Paulo", "Manaus", "Curitiba", "Recife" }));
        lista.add(new Questao("Qual a capital de Amazonas?", "Manaus",
                        new String[] { "Alagoas", "Curitiba", "São Paulo", "Manaus" }));
        ...
        lista.add(new Questao("Qual a capital de Pernambuco?", "Recife",
                        new String[] { "Rio de Janeiro", "Curitiba", "Porto Alegre", "Recife" }));
    ...
    private void configurarBotoes() {
        ...
        root.getChildren().addAll(alternativa1, alternativa2, alternativa3, alternativa4);
